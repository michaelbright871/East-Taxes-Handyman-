...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "East Texas Handyman Services | Longview, TX" },
      {
        name: "description",
        content:
          "Reliable handyman services in Longview, Texas — repairs, carpentry, painting, drywall, doors, decks and property maintenance.",
      },
      { name: "author", content: "East Texas Handyman Services" },
      { property: "og:site_name", content: "East Texas Handyman Services" },
